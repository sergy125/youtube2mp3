        ...
        with st.spinner("Convirtiendo tu audio..."):
            try:
                ...
                ydl_opts = {
                    ...
                    # YouTube exige resolver un reto en JavaScript para dar
                    # acceso a los formatos. Usamos Node (instalado vía
                    # packages.txt) y dejamos que yt-dlp descargue los
                    # scripts EJS necesarios desde GitHub en tiempo de
                    # ejecución.
                    'js_runtimes': {'node': {}},
